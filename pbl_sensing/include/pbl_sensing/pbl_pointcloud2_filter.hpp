...
class pbl_pointcloud2_filter : public rclcpp::Node {
   ...
   private:
    ...
    sensor_msgs::msg::PointCloud2 filter_navigation_points (const sensor_msgs::msg::PointCloud2 &cloud, double lidar_x) const;

    rclcpp::Subscription<sensor_msgs::msg::PointCloud2>::SharedPtr     cloud_sub_;
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr        filtered_cloud_pub_;
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr        filtered_cloud_transformed_pub_;
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr        navigation_cloud_pub_;
    ...
    std::string               navigation_output_topic_;
    std::string               navigation_lidar_frame_id_;
    std::string               target_frame_id_;
    double                    transform_timeout_sec_;
    double                    navigation_min_height_;
    double                    navigation_max_height_;
